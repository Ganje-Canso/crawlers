...
class CansocrawlerPipeline(object):
    ...
    def open_spider(self, spider):
        self.conn = psycopg2.connect(database="canso", user="postgres", password="104603415204", host="localhost", port="5433")
