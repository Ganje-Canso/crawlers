...
class CedarSpider(scrapy.Spider):
    name = 'cedar'
    allowed_domains = ['api.cedarmaps.com']

    def start_requests(self):
        for province, citys in PROVINCE_DATA.items():
            for city in citys:
                yield scrapy.Request(
                    url=f"https://api.cedarmaps.com/v1/geocode/cedarmaps.streets/{city}?limit=30&access_token=38e7430969a851d719f4ae5aa2fdc8d4935ac202",
